...
import io.github.lishangbu.orange.authorization.mapper.OauthAuthorizationConsentMapper;
...
public class DefaultOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
  private final OauthAuthorizationConsentMapper oauthAuthorizationConsentMapper;
  private final RegisteredClientRepository registeredClientRepository;

  public DefaultOAuth2AuthorizationConsentService(
      OauthAuthorizationConsentMapper authorizationConsentRepository,
      RegisteredClientRepository registeredClientRepository) {
    Assert.notNull(authorizationConsentRepository, "authorizationConsentRepository cannot be null");
    Assert.notNull(registeredClientRepository, "registeredClientRepository cannot be null");
    this.oauthAuthorizationConsentMapper = authorizationConsentRepository;
  ...
  public void save(OAuth2AuthorizationConsent authorizationConsent) {
    ...
    this.oauthAuthorizationConsentMapper.insertOrUpdate(toEntity(authorizationConsent));
  }

  @Override
  public void remove(OAuth2AuthorizationConsent authorizationConsent) {
    Assert.notNull(authorizationConsent, "authorizationConsent cannot be null");
    this.oauthAuthorizationConsentMapper.deleteByRegisteredClientIdAndPrincipalName(
  ...
  public OAuth2AuthorizationConsent findById(String registeredClientId, String principalName) {
    ...
    return this.oauthAuthorizationConsentMapper
